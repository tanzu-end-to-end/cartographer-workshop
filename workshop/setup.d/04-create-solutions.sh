...
envsubst < exercises/solutions/springboot-workload.yaml > /tmp/springboot-workload.yaml && mv /tmp/springboot-workload.yaml exercises/solutions/springboot-workload.yaml